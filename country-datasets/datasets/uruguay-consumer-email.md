...
# Uruguay Consumer Email Consumer Email Dataset

## Dataset Overview

The **Uruguay Consumer Email dataset** represents structured contact data commonly used in marketing research, CRM testing, audience segmentation, and data science experiments.
...
Datasets similar to the **Uruguay Consumer Email dataset** are commonly used for:
...
See the official dataset page: https://leadsblue.com/leads/uruguay-consumer-email-database/
